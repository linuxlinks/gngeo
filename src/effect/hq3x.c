...
#ifdef I386_ASM
void hq3x_16_i386(Uint8*, Uint8*, int, int, int);
#endif

int effect_hq3x_init(void)
{
#ifdef I386_ASM
...
#ifndef I386_ASM
void hq3x_16_def(Uint16 *dst0, Uint16 *dst1, Uint16 *dst2, Uint16 *src0, Uint16 *src1, Uint16 *src2, unsigned count)
{
	unsigned i;
...
void effect_hq3x_update(void)
{
    ...
    hq3x_16_i386((Uint8*)src0, (Uint8*)dst0, visible_area.w, visible_area.h, visible_area.w*6);
}
