...
/* Modified for gngeo: since our src duffer is bigger than dest, we can skip first/last pixel test */

static inline void scale2x_8_def_single(scale2x_Uint8* dst, const scale2x_Uint8* src0, const scale2x_Uint8* src1, const scale2x_Uint8* src2, unsigned count)
{
	assert(count >= 2);
#if 0
	/* first pixel */
...
static  inline void scale2x_16_def_single(scale2x_Uint16* dst, const scale2x_Uint16* src0, const scale2x_Uint16* src1, const scale2x_Uint16* src2, unsigned count)
{
	assert(count >= 2);
#if 0
	/* first pixel */
...
static  inline void scale2x_32_def_single(scale2x_Uint32* dst, const scale2x_Uint32* src0, const scale2x_Uint32* src1, const scale2x_Uint32* src2, unsigned count)
{
	assert(count >= 2);
#if 0
	/* first pixel */
 ...
 * \param dst1 Second destination row, double length in pixels.
 */
static  inline void scale2x_8_mmx(scale2x_Uint8* dst0, scale2x_Uint8* dst1, const scale2x_Uint8* src0, const scale2x_Uint8* src1, const scale2x_Uint8* src2, unsigned count)
{
	assert(count >= 16);
	assert(count % 8 == 0);
 ...
 * \param dst1 Second destination row, double length in pixels.
 */
static  inline void scale2x_16_mmx(scale2x_Uint16* dst0, scale2x_Uint16* dst1, const scale2x_Uint16* src0, const scale2x_Uint16* src1, const scale2x_Uint16* src2, unsigned count)
{
	assert(count >= 8);
	assert(count % 4 == 0);
 ...
 * \param dst1 Second destination row, double length in pixels.
 */
static  inline void scale2x_32_mmx(scale2x_Uint32* dst0, scale2x_Uint32* dst1, const scale2x_Uint32* src0, const scale2x_Uint32* src1, const scale2x_Uint32* src2, unsigned count)
{
	assert(count >= 4);
	assert(count % 2 == 0);
